        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <h3 class="title"><a href="">إشارات المنع</a></h3>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">تحذيرية</li>
              <li data-filter=".filter-card">مانعة</li>
              <li data-filter=".filter-web">إلزامية</li>
            </ul>
          </div>
        </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>العنوان</h3>
                  <p>دمشق - أبو رمانة - جانب حديقة المدفع</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <p>info@mot.gov.sy<br>min-trans@mot.gov.sy</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box mt-4">
                  ...
                  <h3>الهاتف</h3>
                  <p>173 011 963+<br>3340218 011 963+</p>
                </div>
              </div>
            </div>
