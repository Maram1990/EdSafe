...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html" class="logo"><img src="public/assets/img/لوغو وزارة النقل  للخلفية.png" alt="" class="img-fluid"></a><a href=" {{ url('/')}}">السلامة المرورية</a></h1>
